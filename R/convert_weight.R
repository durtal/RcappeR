...
#'
#' @param wgt vector of weights to be converted, see examples.
#' @param regex specific regular expression to split wgt by (if wgt is
#' a character string representing stones and lbs)
#' @param from convert from "kg" to lbs, if wgt is numeric
#' @param round round weight to nearest
#'
#' @export
#' @examples
#' \dontrun{
